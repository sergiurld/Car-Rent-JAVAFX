...
public class ModifyCarController {
    ...
    public void setService(Service service, Car car){
    ...
    public void handleModifyCarFromAdmin(ActionEvent actionEvent) {
        ...
        if (make != null && model != null && fuel != null && vin != null && color != null && year != null && km != null && seats != null && power != null) {
            ...
            if (km > 0 && year >= 1950 && seats > 0 && power > 0) {
                service.modifyCar(car, make,model,fuel,vin,year,km,"available",color,seats,power);
